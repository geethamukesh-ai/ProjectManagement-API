...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        ...
        Version = "v1",
        Description = "A comprehensive API for managing projects, users, contracts, documents, and approvals"
    });
...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidAudience = jwtSettings["Audience"] ?? "ProjectManagementAPIUsers",
